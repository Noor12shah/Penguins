...
from Megumi.modules.helper_funcs.extraction import extract_user_and_text
from Megumi.modules.helper_funcs.string_handling import extract_time
from Megumi.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text("This person is my dev - I would never do anything against them!.")
            return log_message
        elif user_id in SUDO_USERS:
            message.reply_text(
                "This person is one of my sudo - I would never do anything against them!."
            )
            return log_message
