...
from Megumi import dispatcher, LOGGER, OWNER_ID, MESSAGE_DUMP
from Megumi.__main__ import DATA_IMPORT
...
# from Megumi.modules.rules import get_rules
import Megumi.modules.sql.rules_sql as rulessql

# from Megumi.modules.sql import warns_sql as warnssql
import Megumi.modules.sql.blacklist_sql as blacklistsql
from Megumi.modules.sql import disable_sql as disabledsql

# from Megumi.modules.sql import cust_filters_sql as filtersql
# import Megumi.modules.sql.welcome_sql as welcsql
import Megumi.modules.sql.locks_sql as locksql
from Megumi.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                "An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @BlessingSupport"
            )
...
def export_data(update, context):
    ...
    f = open("Megumi{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Megumi{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Megumi-Backup` was specially made for notes."
        .format(chat.title, chat_id, tgl),
        timeout=360,
        reply_to_message_id=msg.message_id,
        parse_mode=ParseMode.MARKDOWN,
    )
    os.remove("Megumi{}.backup".format(chat_id))  # Cleaning file
