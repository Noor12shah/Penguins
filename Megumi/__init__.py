...
if ENV:
    ...
    from Megumi.config import Development as Config
...
telethn = TelegramClient("megumi", API_ID, API_HASH)
...
from Megumi.modules.helper_funcs.handlers import (CustomCommandHandler,
